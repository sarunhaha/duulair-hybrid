...
export class IntentAgent extends BaseAgent {
  ...
  private patterns = {
    ...
    list_patients: [
      ...
      /^ทั้งหมด$/, /^รายชื่อ$/,
      /ผู้ป่วย.*ทั้งหมด.*มี/, /ทั้งหมด.*มี.*กี่/, /ผู้ป่วย.*ทั้งหมด.*กี่/,
      /กี่.*คน/, /จำนวนผู้ป่วย/
    ],
...
- list_patients (รายชื่อผู้ป่วย, ผู้ป่วยทั้งหมด, มีกี่คน, ผู้ป่วยมีกี่คน)
- switch_patient (/switch, เปลี่ยนผู้ป่วย, สลับผู้ป่วย)
- set_default_patient (/setdefault, ตั้งผู้ป่วยหลัก, ตั้งค่าผู้ป่วย)
- remove_default_patient (/removedefault, ลบผู้ป่วยหลัก, ยกเลิก default)
