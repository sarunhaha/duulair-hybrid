...
export class IntentAgent extends BaseAgent {
  ...
  private patterns = {
    ...
    report: [/รายงาน/, /สรุป/, /ดู.*ผล/, /วันนี้/, /สัปดาห์/, /📊.*รายงาน/, /ดูรายงาน/],
  ...
  private async classifyWithClaude(text: string) {
    const systemPrompt = `You are an intent classifier for Duulair - a Group-Based Care platform where CAREGIVERS manage patient care.
